    ...
    <section class="pt-3">
        <div class="container">
                    ...
                    <div class="main_contact_box">
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-12 col-md-6">
                                <input type="text" class="form-control" id="your Name" aria-describedby="First Name"
                                    placeholder="your Name" title="Enter your Name" required>
                            </div>
                            <div class="col-xl-12 col-lg-12 col-md-6">
                                <input type="text" class="form-control" id="patel" aria-describedby="Last Name"
                                    title="Enter your Last Name" placeholder="Last Name" required>
                            </div>
                            <div class="col-xl-12">
                                <input type="email" class="form-control" id="medarmis11@gmail.com"
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-6">
                            <input type="confirm password" class="form-control" id="confirm password"
                                placeholder="Confirm Password" aria-describedby="ConfirmPassword"
            ...
            <!--div class="col-xl-6 col-lg-6 col-md-12 right_main_img order-lg-2 order-1">
                    <img src="images/contact_main.png" class="img-fluid up-down" alt="image">
                </div-->
        </div>
        </div>
    </section>
